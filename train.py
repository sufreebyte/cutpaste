...
def get_args():
    ...
    parser.add_argument('--num_epochs', default=265)
...
class CutPaste(pl.LightningModule):
    def __init__(self, hparams):
        ...
        self.model = CutPasteNet(encoder=hparams.encoder, pretrained=hparams.pretrained, dims=hparams.dims,
                                 num_class=int(hparams.num_class))
...
if __name__ == "__main__":
    ...
    trainer = pl.Trainer.from_argparse_args(args, logger=logger, gpus=args.num_gpus, callbacks=[checkpoint_callback],
                                            max_epochs=args.num_epochs)
    trainer.fit(model)

    #  python train.py --dataset_path E:\CutPaste-main\Data\screw\train --num_class 2
    # anaconda终端：python E:\CutPaste-main\train.py --dataset_path E:\CutPaste-main\Data\screw\train --num_class 2
